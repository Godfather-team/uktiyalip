...
const categories = {
  ...
  '💰 Ekonomi': [
    '`/balance [kullanıcı]` — Bakiye',
    '`/daily` — Günlük ödül',
    '`/gamble [miktar]` — Slot makinesi',
    '`/leaderboard` — Sıralama (ekonomi/seviye)',
    '`/pay [kullanıcı] [miktar]` — Para transferi',
  ],
  '⭐ Seviye': [
    '`/rank [kullanıcı]` — Seviye kartı',
    '`/leaderboard seviye` — Seviye sıralaması',
  ],
  '🎲 Eğlence': [
